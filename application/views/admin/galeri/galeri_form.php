<div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <?php $this->view('messages')?>
                    <div class="card">
                        <div class="header">
                            <h2><?=ucfirst($page)?> Galeri</h2>
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    <ul class="pull-right">
                                        <!-- <a href="site_url('galeri')" type="button" class="btn btn-warning waves-effect">
						...
						<?php //echo validation_errors(); ?>
                            <?php echo form_open_multipart('galeri/process')?>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="hidden" class="form-control" name="id" value="<?=$row->galeri_id?>">
									...
									<div class="form-line">
                                        <?php if($page == 'edit'){
                                            if($row->image) { ?> 
                                                ...
                                                <img src="<?=base_url('images/galeri/'.$row->image)?>" style="width:80px" >
                                                </div>
                                            <?php
                                            }
                                        } ?>
