...
<head>
    ...
    <title>Sign In | Eskasaba Comti</title>
    <!-- Favicon-->
...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">Eskasaba<b>Comti</b></a>
            <small>EskasabaComti - Login</small>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_in" action="<?=site_url('auth/process') ?>" method="POST">
